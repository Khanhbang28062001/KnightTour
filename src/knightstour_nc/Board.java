...
//
        ...
        FlowLayout flo2 = new FlowLayout(FlowLayout.CENTER, 0, 0);
        JPanel bottomPanel2 = new JPanel();
        bottomPanel2.setLayout(flo2);
        bottomPanel2.setBackground(new Color(225, 204, 204));
        
//        
        JLabel jlbPoint  = new JLabel("                  A            ");
        JLabel jlbPoint1 = new JLabel("                  B            ");
        JLabel jlbPoint2 = new JLabel("                  C            ");
        JLabel jlbPoint3 = new JLabel("                  D            ");
        JLabel jlbPoint4 = new JLabel("                  E            ");
        JLabel jlbPoint5 = new JLabel("                  F            ");
        JLabel jlbPoint6 = new JLabel("                  G            ");
        JLabel jlbPoint7 = new JLabel("                  H            ");
...
//        this.add(jpanel2, BorderLayout.NORTH);
        jpanel2.add(board);
        jpanel2.add(bottomPanel2);
        
        bottomPanel.add(jlbPoint);
        bottomPanel.add(jlbPoint1);
        bottomPanel.add(jlbPoint2);
        bottomPanel.add(jlbPoint3);
        bottomPanel.add(jlbPoint4);
        bottomPanel.add(jlbPoint5);
        bottomPanel.add(jlbPoint6);
        bottomPanel.add(jlbPoint7);
